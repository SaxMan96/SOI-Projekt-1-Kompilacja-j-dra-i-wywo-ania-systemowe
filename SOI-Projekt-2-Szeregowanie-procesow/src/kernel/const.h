...
#define USER_Q             2	/* ready users of A are scheduled via queue 2 */
#define USER_QB		   3    /* ready users of B are scheduled via queue 2 */
#define USER_QC		   4    /* ready users of C are scheduled via queue 2 */
